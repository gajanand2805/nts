...
const DocsSallaPage = () => {
  ...
  return (
    <DocsContentWrapper
      crumbs={crumbs}
      heading="Salla"
      description={t('Docs_Webhooks_Salla_Description')}>
      <div className="flex flex-col items-start justify-start w-full gap-8">
        <div className="flex flex-col items-start justify-start w-full gap-2">
          <p className="font-bold">{t('Docs_Webhooks_Salla_Step1')}</p>
          <p>{t('Docs_Webhooks_Salla_Step1_text')}</p>
        </div>
        <div className="flex flex-col items-start justify-start w-full gap-2">
          <p className="font-bold">{t('Docs_Webhooks_Salla_Step2')}</p>
          <p>{t('Docs_Webhooks_Salla_Step2_text')}</p>

          <ul className="flex flex-col items-start justify-start w-full">
            <li className="flex justify-start gap-4 break-all">
              <span className="font-medium">1.</span>
              Link: https://api.invobot.net/Webhook/v1.0/salla/(Merchant_ID)
            </li>
            <li className="flex justify-start gap-4 break-all">
        ...
        <div className="flex flex-col items-start justify-start w-full gap-2">
          <p className="font-bold">{t('Docs_Webhooks_Salla_Step3')}</p>
          <p>{t('Docs_Webhooks_Salla_Step3_text')}</p>
        ...
        <div className="flex flex-col items-start justify-start w-full gap-2">
          <p className="font-bold">{t('Docs_Webhooks_Salla_Step4')}</p>
          <p>{t('Docs_Webhooks_Salla_Step4_text')}</p>
        </div>
      </div>
    </DocsContentWrapper>
  )
